# -*- coding: utf-8 -*-
"""
Created on Sat Aug 20 11:04:41 2016
...
def edit_profile_admin(id):
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        flash('The pro file has been updated.')
...
def edit(id):
    post = Post.query.get_or_404(id)
    if current_user.username != post.author and not current_user.can(Permission.ADMINISTER):
        abort(403)
    form = PostForm()
    if form.validate_on_submit():
